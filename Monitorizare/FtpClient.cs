...
public class FtpClient
{
    ...
    public void Login()
    {
        ...
        try
        {
            ...
            // addr = Dns.Resolve(this.server).AddressList[0]; // Dns.Resolve is obsolete ?
    ...
    private Socket createDataSocket()
    {
        ...
        // Console.WriteLine(String.Format("ipData: {0}", ipData)); // ipData: 10,0,0,11,214,47
        ...
        try
        {
            ...
            //ep = new IPEndPoint(Dns.Resolve(ipAddress).AddressList[0], port); // obsolete?

            System.Net.IPAddress ipa = null;
            bool isValidIp = System.Net.IPAddress.TryParse(ipAddress, out ipa);
